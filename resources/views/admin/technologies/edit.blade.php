...
<section class="create col-10 mx-auto">
    <div class="container">
        ...
        <div class="py-4">
            <h2 class="text-muted text-uppercase">Edit Technology: {{$technology->name}}</h2>
        </div>
            ...
            <div class="row row-cols-1 row-cols-md-2">
                ...
                <div class="col">
                    <div>
                        ...
                        <input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror" placeholder="" aria-describedby="helpId" value=" {{old('name', $technology->name)}}" required>
